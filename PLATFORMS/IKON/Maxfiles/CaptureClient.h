/**\file */
#ifndef SLIC_DECLARATIONS_CaptureClient_H
#define SLIC_DECLARATIONS_CaptureClient_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define CaptureClient_capture_if_name ("QSFP_TOP_10G_PORT1")
#define CaptureClient_USE_NETWORK_MANAGER (1)
#define CaptureClient_server_if_name ("QSFP_TOP_10G_PORT2")
#define CaptureClient_capture_precision (8)
 ...
 */
void CaptureClient_enableRemoteCapture(
 ...
 */
max_run_t *CaptureClient_enableRemoteCapture_nonblock(
	uint8_t param_socketsALen,
	uint8_t param_socketsBLen,
	const uint8_t *param_socketsA,
	const uint8_t *param_socketsB);
 ...
 */
void CaptureClient_enableRemoteCapture_run(
	max_engine_t *engine,
	CaptureClient_enableRemoteCapture_actions_t *interface_actions);
 ...
 */
max_run_t *CaptureClient_enableRemoteCapture_run_nonblock(
	max_engine_t *engine,
	CaptureClient_enableRemoteCapture_actions_t *interface_actions);
 ...
 */
void CaptureClient_enableRemoteCapture_run_group(max_group_t *group, CaptureClient_enableRemoteCapture_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_enableRemoteCapture_run_group_nonblock(max_group_t *group, CaptureClient_enableRemoteCapture_actions_t *interface_actions);
 ...
 */
void CaptureClient_enableRemoteCapture_run_array(max_engarray_t *engarray, CaptureClient_enableRemoteCapture_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_enableRemoteCapture_run_array_nonblock(max_engarray_t *engarray, CaptureClient_enableRemoteCapture_actions_t *interface_actions[]);
 ...
 */
max_actions_t* CaptureClient_enableRemoteCapture_convert(max_file_t *maxfile, CaptureClient_enableRemoteCapture_actions_t *interface_actions);



/*----------------------------------------------------------------------------*/
/*----------------------- Interface enableLocalCapture -----------------------*/
/*----------------------------------------------------------------------------*/
...
/**
 * \brief Basic static function for the interface 'enableLocalCapture'.
 * 
 */
void CaptureClient_enableLocalCapture(
	void);

/**
 * \brief Basic static non-blocking function for the interface 'enableLocalCapture'.
 * 
 * Schedule to run on an engine and return immediately.
 * The status of the run can be checked either by ::max_wait or ::max_nowait;
 * note that one of these *must* be called, so that associated memory can be released.
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *CaptureClient_enableLocalCapture_nonblock(
	void);

/**
 * \brief Advanced static interface, structure for the engine interface 'enableLocalCapture'
 * 
 */
typedef struct { 
	int : 0;    /**< non-empty struct with no named members */
} CaptureClient_enableLocalCapture_actions_t;

/**
 * \brief Advanced static function for the interface 'enableLocalCapture'.
 * 
 * \param [in] engine The engine on which the actions will be executed.
 * \param [in,out] interface_actions Actions to be executed.
 */
void CaptureClient_enableLocalCapture_run(
	max_engine_t *engine,
	CaptureClient_enableLocalCapture_actions_t *interface_actions);

/**
 * \brief Advanced static non-blocking function for the interface 'enableLocalCapture'.
 *
 * Schedule the actions to run on the engine and return immediately.
 * The status of the run can be checked either by ::max_wait or ::max_nowait;
 * note that one of these *must* be called, so that associated memory can be released.
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_enableLocalCapture_run_nonblock(
	max_engine_t *engine,
	CaptureClient_enableLocalCapture_actions_t *interface_actions);

/**
 * \brief Group run advanced static function for the interface 'enableLocalCapture'.
 * 
 * \param [in] group Group to use.
 * \param [in,out] interface_actions Actions to run.
 *
 * Run the actions on the first device available in the group.
 */
void CaptureClient_enableLocalCapture_run_group(max_group_t *group, CaptureClient_enableLocalCapture_actions_t *interface_actions);

/**
 * \brief Group run advanced static non-blocking function for the interface 'enableLocalCapture'.
 * 
 *
 * Schedule the actions to run on the first device available in the group and return immediately.
 * The status of the run must be checked with ::max_wait. 
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_enableLocalCapture_run_group_nonblock(max_group_t *group, CaptureClient_enableLocalCapture_actions_t *interface_actions);

/**
 * \brief Array run advanced static function for the interface 'enableLocalCapture'.
 * 
 * \param [in] engarray The array of devices to use.
 * \param [in,out] interface_actions The array of actions to run.
 *
 ...
 * must match the size of engarray.
 */
void CaptureClient_enableLocalCapture_run_array(max_engarray_t *engarray, CaptureClient_enableLocalCapture_actions_t *interface_actions[]);

/**
 * \brief Array run advanced static non-blocking function for the interface 'enableLocalCapture'.
 * 
 *
 * Schedule to run the array of actions on the array of engines, and return immediately.
 * The length of interface_actions must match the size of engarray.
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_enableLocalCapture_run_array_nonblock(max_engarray_t *engarray, CaptureClient_enableLocalCapture_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* CaptureClient_enableLocalCapture_convert(max_file_t *maxfile, CaptureClient_enableLocalCapture_actions_t *interface_actions);
 ...
 * \param [in] inmem_timestampStream_COUNT_8_bcd_dates Mapped ROM inmem_timestampStream_COUNT_8_bcd_dates, should be of size (512 * sizeof(uint64_t)).
 * \param [in] inmem_timestampStream_COUNT_8_correctionInfo Mapped ROM inmem_timestampStream_COUNT_8_correctionInfo, should be of size (2 * sizeof(uint64_t)).
 * \param [in] inmem_timestampStream_COUNT_8_epoch Mapped ROM inmem_timestampStream_COUNT_8_epoch, should be of size (2 * sizeof(uint64_t)).
 * \param [in] inmem_timestampStream_COUNT_8_currentTime Input for mapped RAM timestampStream_COUNT_8.currentTime, should be of size (2 * sizeof(uint64_t))
 * \param [out] outmem_timestampStream_COUNT_8_currentTime Output for mapped RAM timestampStream_COUNT_8.currentTime, should be of size (2 * sizeof(uint64_t))
 * \param [in] inmem_timestampStream_COUNT_8_current_index Input for mapped RAM timestampStream_COUNT_8.current_index, should be of size (2 * sizeof(uint64_t))
 * \param [out] outmem_timestampStream_COUNT_8_current_index Output for mapped RAM timestampStream_COUNT_8.current_index, should be of size (2 * sizeof(uint64_t))
...
void CaptureClient(
	...
	const uint64_t *inmem_timestampStream_COUNT_8_bcd_dates,
	const uint64_t *inmem_timestampStream_COUNT_8_correctionInfo,
	const uint64_t *inmem_timestampStream_COUNT_8_epoch,
	const uint64_t *inmem_timestampStream_COUNT_8_currentTime,
	uint64_t *outmem_timestampStream_COUNT_8_currentTime,
	const uint64_t *inmem_timestampStream_COUNT_8_current_index,
	uint64_t *outmem_timestampStream_COUNT_8_current_index,
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *CaptureClient_nonblock(
	uint64_t inscalar_SenderK_socketA0,
	uint64_t inscalar_SenderK_socketA1,
	uint64_t inscalar_SenderK_socketB0,
	uint64_t inscalar_SenderK_socketB1,
...
typedef struct { 
	...
	const uint64_t *inmem_timestampStream_COUNT_8_bcd_dates; /**<  [in] Mapped ROM inmem_timestampStream_COUNT_8_bcd_dates, should be of size (512 * sizeof(uint64_t)). */
	const uint64_t *inmem_timestampStream_COUNT_8_correctionInfo; /**<  [in] Mapped ROM inmem_timestampStream_COUNT_8_correctionInfo, should be of size (2 * sizeof(uint64_t)). */
	const uint64_t *inmem_timestampStream_COUNT_8_epoch; /**<  [in] Mapped ROM inmem_timestampStream_COUNT_8_epoch, should be of size (2 * sizeof(uint64_t)). */
	const uint64_t *inmem_timestampStream_COUNT_8_currentTime; /**<  [in] Input for mapped RAM timestampStream_COUNT_8.currentTime, should be of size (2 * sizeof(uint64_t)) */
	uint64_t *outmem_timestampStream_COUNT_8_currentTime; /**<  [out] Output for mapped RAM timestampStream_COUNT_8.currentTime, should be of size (2 * sizeof(uint64_t)) */
	const uint64_t *inmem_timestampStream_COUNT_8_current_index; /**<  [in] Input for mapped RAM timestampStream_COUNT_8.current_index, should be of size (2 * sizeof(uint64_t)) */
	uint64_t *outmem_timestampStream_COUNT_8_current_index; /**<  [out] Output for mapped RAM timestampStream_COUNT_8.current_index, should be of size (2 * sizeof(uint64_t)) */
	const char * routing_string; /**<  [in] A string containing comma-separated "from_name -> to_name" routing commands. */
} CaptureClient_actions_t;
 ...
 * \param [in,out] interface_actions Actions to be executed.
 */
void CaptureClient_run(
	max_engine_t *engine,
	CaptureClient_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_run_nonblock(
	max_engine_t *engine,
	CaptureClient_actions_t *interface_actions);
 ...
 * Run the actions on the first device available in the group.
 */
void CaptureClient_run_group(max_group_t *group, CaptureClient_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_run_group_nonblock(max_group_t *group, CaptureClient_actions_t *interface_actions);
 ...
 * must match the size of engarray.
 */
void CaptureClient_run_array(max_engarray_t *engarray, CaptureClient_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *CaptureClient_run_array_nonblock(max_engarray_t *engarray, CaptureClient_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* CaptureClient_convert(max_file_t *maxfile, CaptureClient_actions_t *interface_actions);
...
int CaptureClient_has_errors(void);
const char* CaptureClient_get_errors(void);
void CaptureClient_clear_errors(void);
/* Free statically allocated maxfile data */
void CaptureClient_free(void);
/* These are dummy functions for hardware builds. */
int CaptureClient_simulator_start(void);
int CaptureClient_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_CaptureClient_H */
